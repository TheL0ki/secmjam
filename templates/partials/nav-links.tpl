...
<li {if $current_site|in_array:['/orders', '/orders/new', '/orders/menu']}class="active"{/if}><a href="/orders">Bestellungen{if $countUnlockedOrders > 0} <span class="badge">{$countUnlockedOrders}</span>{/if}</a></li>
